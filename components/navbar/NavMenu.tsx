          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            ...
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/haikal-ramadan-17bb57326"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.4}
                link="https://www.instagram.com/nebulabluee/profilecard/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
            ...
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.8}
                link="mailto:nebulabluee194@gmail.com"
              />
            </MagneticEffect>
          </div>
