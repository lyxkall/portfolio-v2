          ...
          <div className="flex w-full justify-between py-12">
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="flex items-center gap-x-2">
                <ContactLink
                  href="https://www.instagram.com/nebulabluee/profilecard/"
                  label="Instagram"
                  icon={
                ...
                />
                <ContactLink
                  href="mailto:nebulabluee194@gmail.com"
                  label="Email"
                  icon={
                ...
                />
                <ContactLink
                  href="https://www.linkedin.com/in/haikal-ramadan-17bb57326"
                  label="LinkedIn"
                  icon={
